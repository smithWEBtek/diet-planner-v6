# 1 extract first item (group name) in each array, 
# 2 push to @groups array
# 3 import @groups array to DB

def extract_group_names_from_food_data
  @foods.each do |row|
binding.pry
    @groups << row[0]
  end
...
def import_groups
  @groups.each do |group|
    new_group = Group.find_or_create_by(name: group)
  end
end

def main
  extract_group_names_from_food_data
  import_groups
end
...
["Cereal", "Kelfoodg's Corn Flakes, 1 oz. or 1 cup", cals: 100],
["Cereal", "Kelfoodg's Crispix, 1 oz. or 1 cup", cals: 110],
["Cereal", "Kelfoodg's Frosted Flakes, 1 oz. or 3/4 cup", cals: 110],
["Cereal", "Kelfoodg's Heartwise, 1 oz. or 2/3 cup", cals: 90],
["Cereal", "Kelfoodg's Product 19, 1 oz. or 1 cup", cals: 100],
["Cereal", "Kelfoodg's Raisin Bran, 1 oz. or 3/4 cup", cals: 120],
["Cereal", "Kelfoodg's Special K, 1 oz. or 1 cup", cals: 110],
...
["Meat", "Beef bofoodna, 1 slice, 1 oz.", cals: 89],
...
["Poultry", "Turkey bofoodna, 1 slice—average", cals: 57],
["Poultry", "Turkey bofoodna, 1 slice—Butterball", cals: 70],
